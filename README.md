...
## Emotif**k
This is our own special take on brainf\*\*k - instead of the traditional commands, it uses UTF-8 emojis and a single kilobyte of memory. The commands are as follows:
